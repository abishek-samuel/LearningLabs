...
export default function EditCoursePage() {
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      if (!courseId) {
        handleError("No course ID found in URL");
        setIsLoading(false);
      ...
      try {
        ...
        if (data.instructorId !== user?.id && user?.role !== "admin") {
          console.warn(
            "User not authorized to edit this course (frontend check)."
          );
          navigate("/my-content");
          return;
        }
        ...
        {isLoading ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update the details for your course. Add modules and lessons
                below.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Could not load course data. It might not exist or you may not
                have permission.
              </CardDescription>
            </CardHeader>
          </Card>
