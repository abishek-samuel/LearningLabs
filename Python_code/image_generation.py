...
def generate_course_image(course_title: str, course_description: str) -> dict:
    """
    ...
    for part in response.candidates[0].content.parts:
        ...
        if part.text is not None:
            ...
            try:
                ...
                save_dir = os.path.abspath(os.path.join(os.getcwd(), "..", "uploads", "course_images"))
                os.makedirs(save_dir, exist_ok=True)

                filename = f"{course_title.replace(' ', '_')}.png"
